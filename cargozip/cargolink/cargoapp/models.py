...
class Trip (models.Model):
    driver = models.ForeignKey(Driver,on_delete=models.SET_NULL, related_name='trips_offered',null=True,blank=True)
    departure_location = models.CharField(max_length=255)
    destination = models.CharField(max_length=255)
    departure_time = models.DateTimeField()

    trip_space = models.PositiveIntegerField(max_length=5000,default=5000)
